...
{\r
    ...
    {\r
        ...
        case 8: return fujii_materialx        (Albedo, base_roughness, V, L) / NdotL;\r
        case 9: return chan_unreal_diffuse    (Albedo, base_roughness, V, L) / NdotL;\r
        case 10: return deon_lambertian_sphere(Albedo,                 V, L) / NdotL;\r
    }\r
}\r
\r
