...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Wi,depthTest:!1,depthWrite:!1})}function Ru(){return new Yi({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:nc(),fragmentShader:`
		...
		`,blending:Wi,depthTest:!1,depthWrite:!1})}function Cu(){return new Yi({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:nc(),fragmentShader:`
