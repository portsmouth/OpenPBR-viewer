...
`)+`
`+f);const v=x+m+o,b=x+f+a,S=Pc(i,i.VERTEX_SHADER,v),E=Pc(i,i.FRAGMENT_SHADER,b);i.attachShader(_,S),i.attachShader(_,E),t.index0AttributeName!==void 0?i.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function T(F){if(r.debug.checkShaderErrors){const N=i.getProgramInfoLog(_).trim(),B=i.getShaderInfoLog(S).trim(),C=i.getShaderInfoLog(E).trim();let O=!0,G=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if(O=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(i,_,S,E);else{const X=Ic(i,S,"vertex"),ee=Ic(i,E,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`

Program Info Log: `+N+`
`+X+`
`+ee)}else N!==""?console.warn("THREE.WebGLProgram: Program Info Log:",N):(B===""||C==="")&&(G=!1);G&&(F.diagnostics={runnable:O,programLog:N,vertexShader:{log:B,prefix:m},fragmentShader:{log:C,prefix:f}})}i.deleteShader(S),i.deleteShader(E),D=new Zs(i,_),y=E_(i,_)}let D;this.getUniforms=function(){return D===void 0&&T(this),D};let y;this.getAttributes=function(){return y===void 0&&T(this),y};let w=t.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return w===!1&&(w=i.getProgramParameter(_,g_)),w},this.destroy=function(){n.releaseStatesOfProgram(this),i.deleteProgram(_),this.program=void 0},this.type=t.shaderType,this.name=t.shaderName,this.id=__++,this.cacheKey=e,this.usedTimes=1,this.program=_,this.vertexShader=S,this.fragmentShader=E,this}let U_=0;class O_{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e){const t=e.vertexShader,n=e.fragmentShader,i=this._getShaderStage(t),s=this._getShaderStage(n),o=this._getShaderCacheForMaterial(e);return o.has(i)===!1&&(o.add(i),i.usedTimes++),o.has(s)===!1&&(o.add(s),s.usedTimes++),this}remove(e){const t=this.materialCache.get(e);for(const n of t)n.usedTimes--,n.usedTimes===0&&this.shaderCache.delete(n.code);return this.materialCache.delete(e),this}getVertexShaderID(e){return this._getShaderStage(e.vertexShader).id}getFragmentShaderID(e){return this._getShaderStage(e.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){const t=this.materialCache;let n=t.get(e);return n===void 0&&(n=new Set,t.set(e,n)),n}_getShaderStage(e){const t=this.shaderCache;let n=t.get(e);return n===void 0&&(n=new B_(e),t.set(e,n)),n}}class B_{constructor(e){this.id=U_++,this.code=e,this.usedTimes=0}}function z_(r,e,t,n,i,s,o){const a=new ah,l=new O_,c=[],u=i.isWebGL2,h=i.logarithmicDepthBuffer,d=i.vertexTextures;let p=i.precision;const g={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distanceRGBA",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function _(y){return y===0?"uv":`uv${y}`}function m(y,w,F,N,B){const C=N.fog,O=B.geometry,G=y.isMeshStandardMaterial?N.environment:null,X=(y.isMeshStandardMaterial?t:e).get(y.envMap||G),ee=X&&X.mapping===lo?X.image.height:null,$=g[y.type];y.precision!==null&&(p=i.getMaxPrecision(y.precision),p!==y.precision&&console.warn("THREE.WebGLProgram.getParameters:",y.precision,"not supported, using",p,"instead."));const K=O.morphAttributes.position||O.morphAttributes.normal||O.morphAttributes.color,oe=K!==void 0?K.length:0;let le=0;O.morphAttributes.position!==void 0&&(le=1),O.morphAttributes.normal!==void 0&&(le=2),O.morphAttributes.color!==void 0&&(le=3);let q,Z,de,ve;if($){const Dt=vn[$];q=Dt.vertexShader,Z=Dt.fragmentShader}else q=y.vertexShader,Z=y.fragmentShader,l.update(y),de=l.getVertexShaderID(y),ve=l.getFragmentShaderID(y);const be=r.getRenderTarget(),Ie=B.isInstancedMesh===!0,Ce=B.isBatchedMesh===!0,Re=!!y.map,Ue=!!y.matcap,z=!!X,vt=!!y.aoMap,ye=!!y.lightMap,ze=!!y.bumpMap,Le=!!y.normalMap,et=!!y.displacementMap,Oe=!!y.emissiveMap,De=!!y.metalnessMap,je=!!y.roughnessMap,pt=y.anisotropy>0,mt=y.clearcoat>0,L=y.iridescence>0,M=y.sheen>0,H=y.transmission>0,te=pt&&!!y.anisotropyMap,Q=mt&&!!y.clearcoatMap,ne=mt&&!!y.clearcoatNormalMap,ge=mt&&!!y.clearcoatRoughnessMap,se=L&&!!y.iridescenceMap,he=L&&!!y.iridescenceThicknessMap,P=M&&!!y.sheenColorMap,re=M&&!!y.sheenRoughnessMap,j=!!y.specularMap,we=!!y.specularColorMap,_e=!!y.specularIntensityMap,Ee=H&&!!y.transmissionMap,me=H&&!!y.thicknessMap,pe=!!y.gradientMap,We=!!y.alphaMap,I=y.alphaTest>0,ce=!!y.alphaHash,J=!!y.extensions,Y=!!O.attributes.uv1,ie=!!O.attributes.uv2,Me=!!O.attributes.uv3;let Xe=Zn;return y.toneMapped&&(be===null||be.isXRRenderTarget===!0)&&(Xe=r.toneMapping),{isWebGL2:u,shaderID:$,shaderType:y.type,shaderName:y.name,vertexShader:q,fragmentShader:Z,defines:y.defines,customVertexShaderID:de,customFragmentShaderID:ve,isRawShaderMaterial:y.isRawShaderMaterial===!0,glslVersion:y.glslVersion,precision:p,batching:Ce,instancing:Ie,instancingColor:Ie&&B.instanceColor!==null,supportsVertexTextures:d,outputColorSpace:be===null?r.outputColorSpace:be.isXRRenderTarget===!0?be.texture.colorSpace:Tt,map:Re,matcap:Ue,envMap:z,envMapMode:z&&X.mapping,envMapCubeUVHeight:ee,aoMap:vt,lightMap:ye,bumpMap:ze,normalMap:Le,displacementMap:d&&et,emissiveMap:Oe,normalMapObjectSpace:Le&&y.normalMapType===Fd,normalMapTangentSpace:Le&&y.normalMapType===eh,metalnessMap:De,roughnessMap:je,anisotropy:pt,anisotropyMap:te,clearcoat:mt,clearcoatMap:Q,clearcoatNormalMap:ne,clearcoatRoughnessMap:ge,iridescence:L,iridescenceMap:se,iridescenceThicknessMap:he,sheen:M,sheenColorMap:P,sheenRoughnessMap:re,specularMap:j,specularColorMap:we,specularIntensityMap:_e,transmission:H,transmissionMap:Ee,thicknessMap:me,gradientMap:pe,opaque:y.transparent===!1&&y.blending===ir,alphaMap:We,alphaTest:I,alphaHash:ce,combine:y.combine,mapUv:Re&&_(y.map.channel),aoMapUv:vt&&_(y.aoMap.channel),lightMapUv:ye&&_(y.lightMap.channel),bumpMapUv:ze&&_(y.bumpMap.channel),normalMapUv:Le&&_(y.normalMap.channel),displacementMapUv:et&&_(y.displacementMap.channel),emissiveMapUv:Oe&&_(y.emissiveMap.channel),metalnessMapUv:De&&_(y.metalnessMap.channel),roughnessMapUv:je&&_(y.roughnessMap.channel),anisotropyMapUv:te&&_(y.anisotropyMap.channel),clearcoatMapUv:Q&&_(y.clearcoatMap.channel),clearcoatNormalMapUv:ne&&_(y.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:ge&&_(y.clearcoatRoughnessMap.channel),iridescenceMapUv:se&&_(y.iridescenceMap.channel),iridescenceThicknessMapUv:he&&_(y.iridescenceThicknessMap.channel),sheenColorMapUv:P&&_(y.sheenColorMap.channel),sheenRoughnessMapUv:re&&_(y.sheenRoughnessMap.channel),specularMapUv:j&&_(y.specularMap.channel),specularColorMapUv:we&&_(y.specularColorMap.channel),specularIntensityMapUv:_e&&_(y.specularIntensityMap.channel),transmissionMapUv:Ee&&_(y.transmissionMap.channel),thicknessMapUv:me&&_(y.thicknessMap.channel),alphaMapUv:We&&_(y.alphaMap.channel),vertexTangents:!!O.attributes.tangent&&(Le||pt),vertexColors:y.vertexColors,vertexAlphas:y.vertexColors===!0&&!!O.attributes.color&&O.attributes.color.itemSize===4,vertexUv1s:Y,vertexUv2s:ie,vertexUv3s:Me,pointsUvs:B.isPoints===!0&&!!O.attributes.uv&&(Re||We),fog:!!C,useFog:y.fog===!0,fogExp2:C&&C.isFogExp2,flatShading:y.flatShading===!0,sizeAttenuation:y.sizeAttenuation===!0,logarithmicDepthBuffer:h,skinning:B.isSkinnedMesh===!0,morphTargets:O.morphAttributes.position!==void 0,morphNormals:O.morphAttributes.normal!==void 0,morphColors:O.morphAttributes.color!==void 0,morphTargetsCount:oe,morphTextureStride:le,numDirLights:w.directional.length,numPointLights:w.point.length,numSpotLights:w.spot.length,numSpotLightMaps:w.spotLightMap.length,numRectAreaLights:w.rectArea.length,numHemiLights:w.hemi.length,numDirLightShadows:w.directionalShadowMap.length,numPointLightShadows:w.pointShadowMap.length,numSpotLightShadows:w.spotShadowMap.length,numSpotLightShadowsWithMaps:w.numSpotLightShadowsWithMaps,numLightProbes:w.numLightProbes,numClippingPlanes:o.numPlanes,numClipIntersection:o.numIntersection,dithering:y.dithering,shadowMapEnabled:r.shadowMap.enabled&&F.length>0,shadowMapType:r.shadowMap.type,toneMapping:Xe,useLegacyLights:r._useLegacyLights,decodeVideoTexture:Re&&y.map.isVideoTexture===!0&&$e.getTransfer(y.map.colorSpace)===tt,premultipliedAlpha:y.premultipliedAlpha,doubleSided:y.side===cn,flipSided:y.side===Ot,useDepthPacking:y.depthPacking>=0,depthPacking:y.depthPacking||0,index0AttributeName:y.index0AttributeName,extensionDerivatives:J&&y.extensions.derivatives===!0,extensionFragDepth:J&&y.extensions.fragDepth===!0,extensionDrawBuffers:J&&y.extensions.drawBuffers===!0,extensionShaderTextureLOD:J&&y.extensions.shaderTextureLOD===!0,rendererExtensionFragDepth:u||n.has("EXT_frag_depth"),rendererExtensionDrawBuffers:u||n.has("WEBGL_draw_buffers"),rendererExtensionShaderTextureLod:u||n.has("EXT_shader_texture_lod"),rendererExtensionParallelShaderCompile:n.has("KHR_parallel_shader_compile"),customProgramCacheKey:y.customProgramCacheKey()}}function f(y){const w=[];if(y.shaderID?w.push(y.shaderID):(w.push(y.customVertexShaderID),w.push(y.customFragmentShaderID)),y.defines!==void 0)for(const F in y.defines)w.push(F),w.push(y.defines[F]);return y.isRawShaderMaterial===!1&&(x(w,y),v(w,y),w.push(r.outputColorSpace)),w.push(y.customProgramCacheKey),w.join()}function x(y,w){y.push(w.precision),y.push(w.outputColorSpace),y.push(w.envMapMode),y.push(w.envMapCubeUVHeight),y.push(w.mapUv),y.push(w.alphaMapUv),y.push(w.lightMapUv),y.push(w.aoMapUv),y.push(w.bumpMapUv),y.push(w.normalMapUv),y.push(w.displacementMapUv),y.push(w.emissiveMapUv),y.push(w.metalnessMapUv),y.push(w.roughnessMapUv),y.push(w.anisotropyMapUv),y.push(w.clearcoatMapUv),y.push(w.clearcoatNormalMapUv),y.push(w.clearcoatRoughnessMapUv),y.push(w.iridescenceMapUv),y.push(w.iridescenceThicknessMapUv),y.push(w.sheenColorMapUv),y.push(w.sheenRoughnessMapUv),y.push(w.specularMapUv),y.push(w.specularColorMapUv),y.push(w.specularIntensityMapUv),y.push(w.transmissionMapUv),y.push(w.thicknessMapUv),y.push(w.combine),y.push(w.fogExp2),y.push(w.sizeAttenuation),y.push(w.morphTargetsCount),y.push(w.morphAttributeCount),y.push(w.numDirLights),y.push(w.numPointLights),y.push(w.numSpotLights),y.push(w.numSpotLightMaps),y.push(w.numHemiLights),y.push(w.numRectAreaLights),y.push(w.numDirLightShadows),y.push(w.numPointLightShadows),y.push(w.numSpotLightShadows),y.push(w.numSpotLightShadowsWithMaps),y.push(w.numLightProbes),y.push(w.shadowMapType),y.push(w.toneMapping),y.push(w.numClippingPlanes),y.push(w.numClipIntersection),y.push(w.depthPacking)}function v(y,w){a.disableAll(),w.isWebGL2&&a.enable(0),w.supportsVertexTextures&&a.enable(1),w.instancing&&a.enable(2),w.instancingColor&&a.enable(3),w.matcap&&a.enable(4),w.envMap&&a.enable(5),w.normalMapObjectSpace&&a.enable(6),w.normalMapTangentSpace&&a.enable(7),w.clearcoat&&a.enable(8),w.iridescence&&a.enable(9),w.alphaTest&&a.enable(10),w.vertexColors&&a.enable(11),w.vertexAlphas&&a.enable(12),w.vertexUv1s&&a.enable(13),w.vertexUv2s&&a.enable(14),w.vertexUv3s&&a.enable(15),w.vertexTangents&&a.enable(16),w.anisotropy&&a.enable(17),w.alphaHash&&a.enable(18),w.batching&&a.enable(19),y.push(a.mask),a.disableAll(),w.fog&&a.enable(0),w.useFog&&a.enable(1),w.flatShading&&a.enable(2),w.logarithmicDepthBuffer&&a.enable(3),w.skinning&&a.enable(4),w.morphTargets&&a.enable(5),w.morphNormals&&a.enable(6),w.morphColors&&a.enable(7),w.premultipliedAlpha&&a.enable(8),w.shadowMapEnabled&&a.enable(9),w.useLegacyLights&&a.enable(10),w.doubleSided&&a.enable(11),w.flipSided&&a.enable(12),w.useDepthPacking&&a.enable(13),w.dithering&&a.enable(14),w.transmission&&a.enable(15),w.sheen&&a.enable(16),w.opaque&&a.enable(17),w.pointsUvs&&a.enable(18),w.decodeVideoTexture&&a.enable(19),y.push(a.mask)}function b(y){const w=g[y.type];let F;if(w){const N=vn[w];F=Sf.clone(N.uniforms)}else F=y.uniforms;return F}function S(y,w){let F;for(let N=0,B=c.length;N<B;N++){const C=c[N];if(C.cacheKey===w){F=C,++F.usedTimes;break}}return F===void 0&&(F=new F_(r,w,y,s),c.push(F)),F}function E(y){if(--y.usedTimes===0){const w=c.indexOf(y);c[w]=c[c.length-1],c.pop(),y.destroy()}}function T(y){l.remove(y)}function D(){l.dispose()}return{getParameters:m,getProgramCacheKey:f,getUniforms:b,acquireProgram:S,releaseProgram:E,releaseShaderCache:T,programs:c,dispose:D}}function H_(){let r=new WeakMap;function e(s){let o=r.get(s);return o===void 0&&(o={},r.set(s,o)),o}function t(s){r.delete(s)}function n(s,o,a){r.get(s)[o]=a}function i(){r=new WeakMap}return{get:e,remove:t,update:n,dispose:i}}function k_(r,e){return r.groupOrder!==e.groupOrder?r.groupOrder-e.groupOrder:r.renderOrder!==e.renderOrder?r.renderOrder-e.renderOrder:r.material.id!==e.material.id?r.material.id-e.material.id:r.z!==e.z?r.z-e.z:r.id-e.id}function Bc(r,e){return r.groupOrder!==e.groupOrder?r.groupOrder-e.groupOrder:r.renderOrder!==e.renderOrder?r.renderOrder-e.renderOrder:r.z!==e.z?e.z-r.z:r.id-e.id}function zc(){const r=[];let e=0;const t=[],n=[],i=[];function s(){e=0,t.length=0,n.length=0,i.length=0}function o(h,d,p,g,_,m){let f=r[e];return f===void 0?(f={id:h.id,object:h,geometry:d,material:p,groupOrder:g,renderOrder:h.renderOrder,z:_,group:m},r[e]=f):(f.id=h.id,f.object=h,f.geometry=d,f.material=p,f.groupOrder=g,f.renderOrder=h.renderOrder,f.z=_,f.group=m),e++,f}function a(h,d,p,g,_,m){const f=o(h,d,p,g,_,m);p.transmission>0?n.push(f):p.transparent===!0?i.push(f):t.push(f)}function l(h,d,p,g,_,m){const f=o(h,d,p,g,_,m);p.transmission>0?n.unshift(f):p.transparent===!0?i.unshift(f):t.unshift(f)}function c(h,d){t.length>1&&t.sort(h||k_),n.length>1&&n.sort(d||Bc),i.length>1&&i.sort(d||Bc)}function u(){for(let h=e,d=r.length;h<d;h++){const p=r[h];if(p.id===null)break;p.id=null,p.object=null,p.geometry=null,p.material=null,p.group=null}}return{opaque:t,transmissive:n,transparent:i,init:s,push:a,unshift:l,finish:u,sort:c}}function V_(){let r=new WeakMap;function e(n,i){const s=r.get(n);let o;return s===void 0?(o=new zc,r.set(n,[o])):i>=s.length?(o=new zc,s.push(o)):o=s[i],o}function t(){r=new WeakMap}return{get:e,dispose:t}}function G_(){const r={};return{get:function(e){if(r[e.id]!==void 0)return r[e.id];let t;switch(e.type){case"DirectionalLight":t={direction:new R,color:new Ne};break;case"SpotLight":t={position:new R,direction:new R,color:new Ne,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":t={position:new R,color:new Ne,distance:0,decay:0};break;case"HemisphereLight":t={direction:new R,skyColor:new Ne,groundColor:new Ne};break;case"RectAreaLight":t={color:new Ne,position:new R,halfWidth:new R,halfHeight:new R};break}return r[e.id]=t,t}}}function W_(){const r={};return{get:function(e){if(r[e.id]!==void 0)return r[e.id];let t;switch(e.type){case"DirectionalLight":t={shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Se};break;case"SpotLight":t={shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Se};break;case"PointLight":t={shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Se,shadowCameraNear:1,shadowCameraFar:1e3};break}return r[e.id]=t,t}}}let X_=0;function q_(r,e){return(e.castShadow?2:0)-(r.castShadow?2:0)+(e.map?1:0)-(r.map?1:0)}function Y_(r,e){const t=new G_,n=W_(),i={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let u=0;u<9;u++)i.probe.push(new R);const s=new R,o=new Te,a=new Te;function l(u,h){let d=0,p=0,g=0;for(let N=0;N<9;N++)i.probe[N].set(0,0,0);let _=0,m=0,f=0,x=0,v=0,b=0,S=0,E=0,T=0,D=0,y=0;u.sort(q_);const w=h===!0?Math.PI:1;for(let N=0,B=u.length;N<B;N++){const C=u[N],O=C.color,G=C.intensity,X=C.distance,ee=C.shadow&&C.shadow.map?C.shadow.map.texture:null;if(C.isAmbientLight)d+=O.r*G*w,p+=O.g*G*w,g+=O.b*G*w;else if(C.isLightProbe){for(let $=0;$<9;$++)i.probe[$].addScaledVector(C.sh.coefficients[$],G);y++}else if(C.isDirectionalLight){const $=t.get(C);if($.color.copy(C.color).multiplyScalar(C.intensity*w),C.castShadow){const K=C.shadow,oe=n.get(C);oe.shadowBias=K.bias,oe.shadowNormalBias=K.normalBias,oe.shadowRadius=K.radius,oe.shadowMapSize=K.mapSize,i.directionalShadow[_]=oe,i.directionalShadowMap[_]=ee,i.directionalShadowMatrix[_]=C.shadow.matrix,b++}i.directional[_]=$,_++}else if(C.isSpotLight){const $=t.get(C);$.position.setFromMatrixPosition(C.matrixWorld),$.color.copy(O).multiplyScalar(G*w),$.distance=X,$.coneCos=Math.cos(C.angle),$.penumbraCos=Math.cos(C.angle*(1-C.penumbra)),$.decay=C.decay,i.spot[f]=$;const K=C.shadow;if(C.map&&(i.spotLightMap[T]=C.map,T++,K.updateMatrices(C),C.castShadow&&D++),i.spotLightMatrix[f]=K.matrix,C.castShadow){const oe=n.get(C);oe.shadowBias=K.bias,oe.shadowNormalBias=K.normalBias,oe.shadowRadius=K.radius,oe.shadowMapSize=K.mapSize,i.spotShadow[f]=oe,i.spotShadowMap[f]=ee,E++}f++}else if(C.isRectAreaLight){const $=t.get(C);$.color.copy(O).multiplyScalar(G),$.halfWidth.set(C.width*.5,0,0),$.halfHeight.set(0,C.height*.5,0),i.rectArea[x]=$,x++}else if(C.isPointLight){const $=t.get(C);if($.color.copy(C.color).multiplyScalar(C.intensity*w),$.distance=C.distance,$.decay=C.decay,C.castShadow){const K=C.shadow,oe=n.get(C);oe.shadowBias=K.bias,oe.shadowNormalBias=K.normalBias,oe.shadowRadius=K.radius,oe.shadowMapSize=K.mapSize,oe.shadowCameraNear=K.camera.near,oe.shadowCameraFar=K.camera.far,i.pointShadow[m]=oe,i.pointShadowMap[m]=ee,i.pointShadowMatrix[m]=C.shadow.matrix,S++}i.point[m]=$,m++}else if(C.isHemisphereLight){const $=t.get(C);$.skyColor.copy(C.color).multiplyScalar(G*w),$.groundColor.copy(C.groundColor).multiplyScalar(G*w),i.hemi[v]=$,v++}}x>0&&(e.isWebGL2||r.has("OES_texture_float_linear")===!0?(i.rectAreaLTC1=ue.LTC_FLOAT_1,i.rectAreaLTC2=ue.LTC_FLOAT_2):r.has("OES_texture_half_float_linear")===!0?(i.rectAreaLTC1=ue.LTC_HALF_1,i.rectAreaLTC2=ue.LTC_HALF_2):console.error("THREE.WebGLRenderer: Unable to use RectAreaLight. Missing WebGL extensions.")),i.ambient[0]=d,i.ambient[1]=p,i.ambient[2]=g;const F=i.hash;(F.directionalLength!==_||F.pointLength!==m||F.spotLength!==f||F.rectAreaLength!==x||F.hemiLength!==v||F.numDirectionalShadows!==b||F.numPointShadows!==S||F.numSpotShadows!==E||F.numSpotMaps!==T||F.numLightProbes!==y)&&(i.directional.length=_,i.spot.length=f,i.rectArea.length=x,i.point.length=m,i.hemi.length=v,i.directionalShadow.length=b,i.directionalShadowMap.length=b,i.pointShadow.length=S,i.pointShadowMap.length=S,i.spotShadow.length=E,i.spotShadowMap.length=E,i.directionalShadowMatrix.length=b,i.pointShadowMatrix.length=S,i.spotLightMatrix.length=E+T-D,i.spotLightMap.length=T,i.numSpotLightShadowsWithMaps=D,i.numLightProbes=y,F.directionalLength=_,F.pointLength=m,F.spotLength=f,F.rectAreaLength=x,F.hemiLength=v,F.numDirectionalShadows=b,F.numPointShadows=S,F.numSpotShadows=E,F.numSpotMaps=T,F.numLightProbes=y,i.version=X_++)}function c(u,h){let d=0,p=0,g=0,_=0,m=0;const f=h.matrixWorldInverse;for(let x=0,v=u.length;x<v;x++){const b=u[x];if(b.isDirectionalLight){const S=i.directional[d];S.direction.setFromMatrixPosition(b.matrixWorld),s.setFromMatrixPosition(b.target.matrixWorld),S.direction.sub(s),S.direction.transformDirection(f),d++}else if(b.isSpotLight){const S=i.spot[g];S.position.setFromMatrixPosition(b.matrixWorld),S.position.applyMatrix4(f),S.direction.setFromMatrixPosition(b.matrixWorld),s.setFromMatrixPosition(b.target.matrixWorld),S.direction.sub(s),S.direction.transformDirection(f),g++}else if(b.isRectAreaLight){const S=i.rectArea[_];S.position.setFromMatrixPosition(b.matrixWorld),S.position.applyMatrix4(f),a.identity(),o.copy(b.matrixWorld),o.premultiply(f),a.extractRotation(o),S.halfWidth.set(b.width*.5,0,0),S.halfHeight.set(0,b.height*.5,0),S.halfWidth.applyMatrix4(a),S.halfHeight.applyMatrix4(a),_++}else if(b.isPointLight){const S=i.point[p];S.position.setFromMatrixPosition(b.matrixWorld),S.position.applyMatrix4(f),p++}else if(b.isHemisphereLight){const S=i.hemi[m];S.direction.setFromMatrixPosition(b.matrixWorld),S.direction.transformDirection(f),m++}}}return{setup:l,setupView:c,state:i}}function Hc(r,e){const t=new Y_(r,e),n=[],i=[];function s(){n.length=0,i.length=0}function o(h){n.push(h)}function a(h){i.push(h)}function l(h){t.setup(n,h)}function c(h){t.setupView(n,h)}return{init:s,state:{lightsArray:n,shadowsArray:i,lights:t},setupLights:l,setupLightsView:c,pushLight:o,pushShadow:a}}function j_(r,e){let t=new WeakMap;function n(s,o=0){const a=t.get(s);let l;return a===void 0?(l=new Hc(r,e),t.set(s,[l])):o>=a.length?(l=new Hc(r,e),a.push(l)):l=a[o],l}function i(){t=new WeakMap}return{get:n,dispose:i}}class $_ extends yn{constructor(e){super(),this.isMeshDepthMaterial=!0,this.type="MeshDepthMaterial",this.depthPacking=Id,this.map=null,this.alphaMap=null,this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.wireframe=!1,this.wireframeLinewidth=1,this.setValues(e)}copy(e){return super.copy(e),this.depthPacking=e.depthPacking,this.map=e.map,this.alphaMap=e.alphaMap,this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this.wireframe=e.wireframe,this.wireframeLinewidth=e.wireframeLinewidth,this}}class K_ extends yn{constructor(e){super(),this.isMeshDistanceMaterial=!0,this.type="MeshDistanceMaterial",this.map=null,this.alphaMap=null,this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.setValues(e)}copy(e){return super.copy(e),this.map=e.map,this.alphaMap=e.alphaMap,this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this}}const Z_=`void main() {
	gl_Position = vec4( position, 1.0 );
...
const float RAY_OFFSET            = 1.0e-3;\r
const float DENOM_TOLERANCE       = 5.0e-7;\r
...
{\r
    Basis basis;\r
    basis.nW = normalize(nW);\r
    if (abs(nW.z) < abs(nW.x))\r
    {\r
        basis.tW.x =  basis.nW.z;\r
        basis.tW.y =  0.0;\r
        basis.tW.z = -basis.nW.x;\r
    }\r
    else\r
    {\r
        basis.tW.x =  0.0;\r
        basis.tW.y = basis.nW.z;\r
        basis.tW.z = -basis.nW.y;\r
    }\r
    basis.tW = safe_normalize(basis.tW);\r
    basis.bW = cross(nW, basis.tW);\r
...
\r
float balanceHeuristic(const float a, const float b)\r
{\r
    return a / (a + b);\r
}\r
\r
...
\r
/*\r
vec3 ggx_ndf_sample(in vec3 wiL, float alpha_x, float alpha_y, inout int rndSeed)\r
{\r
    vec3 Vh = normalize(vec3(alpha_x*wiL.x, alpha_y*wiL.y, wiL.z));\r
    float lensq = Vh.x*Vh.x + Vh.y*Vh.y;\r
    vec3 T1 = lensq > 0.0 ? vec3(-Vh.y, Vh.x, 0.0) * 1.0/max(DENOM_TOLERANCE, sqrt(lensq)) : vec3(1.0, 0.0, 0.0);\r
...
float ggx_G1(in vec3 vLocal, in vec3 mL, float alpha_x, float alpha_y)\r
{\r
    float tanThetaAbs = abs(tanTheta(vLocal));\r
    float epsilon = 1.0e-6;\r
    if (tanThetaAbs < epsilon) return 1.0; // perpendicular incidence -- no shadowing/masking\r
\r
...
\r
float ggx_G2(in vec3 woL, in vec3 wiL, in vec3 mL, float alpha_x, float alpha_y)\r
{\r
    return ggx_G1(woL, mL, alpha_x, alpha_y) * \r
           ggx_G1(wiL, mL, alpha_x, alpha_y);\r
}\r
\r
\r
///////////////////////////////////\r
...
{\r
    return microfacetEval_beckmann(m, alpha_x, alpha_y) * abs(cosTheta(m));\r
}\r
\r
// Shadow-masking function\r
// Approximation from Walter et al (v = arbitrary direction, m = microfacet normal)\r
float beckmann_G1(in vec3 vLocal, in vec3 mLocal, float roughness)\r
{\r
    float tanThetaAbs = abs(tanTheta(vLocal));\r
    float epsilon = 1.0e-6;\r
    if (tanThetaAbs < epsilon) return 1.0; // perpendicular incidence -- no shadowing/masking\r
    //if (dot(vLocal, mLocal) * vLocal.z <= 0.0) return 0.0; // Back side is not visible from the front side, and the reverse.\r
    float a = 1.0 / (max(roughness, epsilon) * tanThetaAbs); // Rational approximation to the shadowing/masking function (Walter et al)  (<0.35% rel. error)\r
    if (a >= 1.6) return 1.0;\r
    float aSqr = a*a;\r
    return (3.535*a + 2.181*aSqr) / (1.0 + 2.276*a + 2.577*aSqr);\r
}\r
\r
float beckmann_G2(in vec3 woL, in vec3 wiL, in vec3 mLocal, float roughness)\r
{\r
    return beckmann_G1(woL, mLocal, roughness) * beckmann_G1(wiL, mLocal, roughness);\r
}`,rb=`\r
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////\r
...
\r
    ...
    return vec3(F) * D * ggx_G2(winputR, woutputR, mR, alpha_x, alpha_y) / max(4.0*abs(woutputL.z)*abs(winputL.z), DENOM_TOLERANCE);\r
}\r
\r
...
\r
    // Compute NDF, and "distribution of visible normals" DV\r
    float D = ggx_ndf_eval(mR, alpha_x, alpha_y);\r
    float DV = ggx_G1(winputR, mR, alpha_x, alpha_y) * max(0.0, dot(winputR, mR)) * D / max(DENOM_TOLERANCE, winputR.z);\r
\r
...
\r
    // Compute NDF, and "distribution of visible normals" DV\r
    float D = ggx_ndf_eval(mR, alpha_x, alpha_y);\r
    float DV = ggx_G1(winputR, mR, alpha_x, alpha_y) * max(0.0, dot(winputR, mR)) * D / winputR.z;\r
\r
    // Thus compute PDF of woutputL sample\r
    float dwh_dwo = 1.0 / max(abs(4.0*dot(winputR, mR)), DENOM_TOLERANCE); // Jacobian of the half-direction mapping\r
...
\r
    ...
    float G2 = ggx_G2(winputR, woutputR, mR, alpha_x, alpha_y);\r
\r
    // Thus evaluate BRDF\r
...
\r
    // Compute NDF, and "distribution of visible normals" DV\r
    float D = ggx_ndf_eval(mR, alpha_x, alpha_y);\r
    float DV = D * ggx_G1(winputR, mR, alpha_x, alpha_y) * max(0.0, dot(winputR, mR)) / max(DENOM_TOLERANCE, winputR.z);\r
\r
    // Thus compute PDF of woutputL sample\r
    float dwh_dwo = 1.0 / max(abs(4.0*dot(winputR, mR)), DENOM_TOLERANCE); // Jacobian of the half-direction mapping\r
    pdf_woutputL = DV * dwh_dwo;\r
...
{\r
    if (winputL.z < DENOM_TOLERANCE) return PDF_EPSILON;\r
\r
    // Construct basis such that x, y are aligned with the T, B in the local, rotated frame\r
    LocalFrameRotation rotation = getLocalFrameRotation(PI2*specular_rotation);\r
    vec3 winputR  = localToRotated(winputL,  rotation);\r
...
\r
    ...
    vec3 woutputR = localToRotated(woutputL, rotation);\r
\r
    // We assume here that the local frame is setup so that the z direction points from the dielectric interior to the exterior:\r
    vec3 beamIncidentR = -woutputR;\r
    bool beam_entering = (beamIncidentR.z < 0.0);\r
\r
    // Compute IOR ratio at interface:\r
    //  eta_ti = (IOR in hemi. of transmitted photon) / (IOR in hemi. of incident photon)\r
    vec3 beamOutgoingR = winputR;\r
    float n_exterior = 1.0;\r
    float n_interior = specular_ior;\r
    float eta_ti = beam_entering ? n_interior/n_exterior : n_exterior/n_interior; \r
    if (abs(eta_ti - 1.0) < 1.0e-4)\r
    {\r
        // degenerate case of index-matched interface, BTDF is a delta-function\r
        return vec3(0.0);\r
    }\r
\r
    // Compute the micronormal mR in the local (rotated) frame, that refracts -woutputR to winputR\r
    vec3 mR = safe_normalize(beamIncidentR - eta_ti*beamOutgoingR);\r
...
\r
    ...
    {\r
        ...
        dwh_dwo = sqr(eta_ti) * abs(om) / max(sqr(im + eta_ti*om), DENOM_TOLERANCE);\r
    }\r
\r
    // Compute the NDF roughnesses in the rotated frame\r
    float alpha_x, alpha_y;\r
...
\r
    ...
    float D = ggx_ndf_eval(mR, alpha_x, alpha_y);\r
\r
    // Compute masking-shadowing term G2\r
    float G2 = ggx_G2(winputR, woutputR, mR, alpha_x, alpha_y);\r
\r
    // Thus evaluate BRDF.\r
    // Note that the (transmission) Fresnel factor is omitted, as it is accounted for (approximately)\r
    // according to the mixture model formulas described in the OpenPBR spec.\r
    float f = abs(im) * dwh_dwo * G2 * D / max(abs(woutputL.z)*abs(winputL.z), DENOM_TOLERANCE);\r
    return f * tint;\r
}\r
\r
// Given the direction (wt) of a light beam transmitted through a plane dielectric interface\r
// with the given normal (n) in any orientation, and the ratio eta_ti = nt/ni of the transmitted IOR (nt) and incident IOR (ni),\r
...
bool refraction_given_transmitted_direction(in vec3 n, in float eta_ti, in vec3 wt, inout vec3 wi)\r
{\r
    float wtn = dot(wt, n);\r
    float disciminant = 1.0 - sqr(eta_ti)*(1.0 - sqr(wtn));\r
    if (disciminant < 0.0)\r
        return false;\r
    wi = eta_ti*wt - n*sign(wtn)*(eta_ti*abs(wtn) - sqrt(disciminant));\r
    return true;\r
}\r
\r
vec3 specular_btdf_sample(in vec3 pW, in Basis basis, in vec3 winputL,\r
                          out vec3 woutputL, out float pdf_woutputL, inout int rndSeed)\r
{\r
    // Construct basis such that x, y are aligned with the T, B in the rotated frame\r
    LocalFrameRotation rotation = getLocalFrameRotation(PI2 * specular_rotation);\r
...
\r
    // We assume here that the local frame is setup so that the z direction points from the dielectric interior to the exterior:\r
    vec3 beamOutgoingR = winputR;\r
    bool beam_entering = (beamOutgoingR.z < 0.0);\r
\r
    // Compute IOR ratio at interface:\r
    //  eta_ti = (IOR in hemi. of transmitted photon) / (IOR in hemi. of incident photon)\r
    float n_exterior = 1.0;\r
    ...
    {\r
        ...
        return tint / (PDF_EPSILON * abs(woutputL.z));\r
    }\r
\r
    // Compute the direction of the refracted ray, woutputL\r
    vec3 beamIncidentR; // the incident photon direction, to be determined (where woutputR = -beamIncidentR)\r
    if (!refraction_given_transmitted_direction(mR, eta_ti, beamOutgoingR, beamIncidentR))\r
    {\r
        pdf_woutputL = PDF_EPSILON;\r
        return vec3(0.0); // (no transmission, in a TIR configuration)\r
    }\r
\r
...
\r
    // Compute NDF, and "distribution of visible normals" DV\r
    float D = ggx_ndf_eval(mR, alpha_x, alpha_y);\r
    float G1 = ggx_G1(winputR, mR, alpha_x, alpha_y);\r
    float DV = D * G1 * abs(dot(winputR, mR)) / max(DENOM_TOLERANCE, abs(winputR.z));\r
\r
    // Thus compute PDF of woutputL sample\r
    pdf_woutputL = DV * dwh_dwo;\r
\r
...
\r
float specular_btdf_pdf(in vec3 pW, in Basis basis, in vec3 winputL, in vec3 woutputL)\r
{\r
    bool reflected = woutputL.z * winputL.z > 0.0;\r
    if (reflected)\r
        return PDF_EPSILON;\r
...
\r
    ...
    {\r
        // degenerate case of index-matched interface, BTDF is a delta-function\r
        return 1.0/PDF_EPSILON;\r
    }\r
\r
    // Compute the micronormal mR in the local (rotated) frame, that refracts -woutputR to winputR\r
    vec3 mR = safe_normalize(beamIncidentR - eta_ti*beamOutgoingR);\r
    if (mR.z <= 0.0) mR *= -1.0; // orient the half-vector in the positive hemisphere\r
\r
    // Compute Jacobian of the half-direction mapping\r
    float im = dot(-beamIncidentR, mR);\r
    float dwh_dwo; \r
...
\r
vec3 specular_btdf_albedo(in vec3 pW, in Basis basis, in vec3 winputL,\r
                          inout int rndSeed)\r
{\r
    float n_exterior = 1.0;\r
    float n_interior = specular_ior;\r
    float eta_ie = n_interior/n_exterior;  \r
    if (abs(eta_ie - 1.0) < 1.0e-4)\r
    {\r
        // degenerate case of index-matched interface, BTDF is a delta-function\r
        return vec3(1.0);\r
    }\r
\r
    ...
    {\r
        vec3 woutputL;\r
        float pdf_woutputL;\r
        vec3 f = specular_btdf_sample(pW, basis, winputL, woutputL, pdf_woutputL, rndSeed);\r
        if (length(f) > RADIANCE_EPSILON)\r
            albedo += f * abs(woutputL.z) / max(DENOM_TOLERANCE, pdf_woutputL);\r
    }\r
    albedo /= float(num_samples);\r
...
\r
        ...
        //if (maxComponent(weights.m[ID_COAT_BRDF]) > 0.0) albedos.m[ID_COAT_BRDF] = coat_brdf_albedo(pW, basis, winputL, rndSeed);\r
...
\r
                    //////////////////////////////////////////////\r
                    // Translucent dielectric base\r
                    //////////////////////////////////////////////\r
\r
                    // Specular BRDF    \r
                    vec3 w_dielectric_base = vec3(1.0); //w_base_substrate * vec3(1.0 - base_metalness);\r
                    weights.m[ID_SPEC_BRDF] = w_dielectric_base;\r
                    if (maxComponent(weights.m[ID_SPEC_BRDF]) > 0.0) albedos.m[ID_SPEC_BRDF] = specular_brdf_albedo(pW, basis, winputL, rndSeed);\r
...
\r
                        // Diffuse BRDF\r
                        //weights.m[ID_DIFF_BRDF] = vec3(0.0); //w_dielectric_base_btdf * (1.0 - transmission_weight) * (1.0 - subsurface_weight);\r
\r
                        // Subsurface BSSRDF\r
                        //weights.m[ID_SSSC_BTDF] = vec3(0.0); w_dielectric_base_btdf * (1.0 - transmission_weight) * subsurface_weight;\r
\r
\r
}\r
\r
...
{\r
    //if (maxComponent(weights.m[ID_META_BRDF]) > 0.0) albedos.m[ID_META_BRDF] = metal_brdf_albedo(pW, basis, winputL, rndSeed);\r
    //else                                             albedos.m[ID_META_BRDF] = vec3(0.0);\r
    //if (maxComponent(weights.m[ID_DIFF_BRDF]) > 0.0) albedos.m[ID_DIFF_BRDF] = diffuse_brdf_albedo(pW, basis, winputL, rndSeed);\r
    //else                                             albedos.m[ID_DIFF_BRDF] = vec3(0.0);\r
    //if (maxComponent(weights.m[ID_SSSC_BTDF]) > 0.0) albedos.m[ID_SSSC_BTDF] = subsurface_btdf_albedo(pW, basis, winputL, rndSeed);\r
    //else                                             albedos.m[ID_SSSC_BTDF] = vec3(0.0);\r
    if (maxComponent(weights.m[ID_SPEC_BTDF]) > 0.0) albedos.m[ID_SPEC_BTDF] = specular_btdf_albedo(pW, basis, winputL, rndSeed);\r
...
{\r
    ...
    //if (maxComponent(weights.m[ID_COAT_BRDF]) > 0.0) f += weights.m[ID_COAT_BRDF] *     coat_brdf_evaluate(pW, basis, winputL, woutputL, rndSeed);\r
    //if (maxComponent(weights.m[ID_META_BRDF]) > 0.0) f += weights.m[ID_META_BRDF] *    metal_brdf_evaluate(pW, basis, winputL, woutputL, rndSeed);\r
    if (maxComponent(weights.m[ID_SPEC_BRDF]) > 0.0) f += weights.m[ID_SPEC_BRDF] * specular_brdf_evaluate(pW, basis, winputL, woutputL, rndSeed);\r
    if (maxComponent(weights.m[ID_SPEC_BTDF]) > 0.0) f += weights.m[ID_SPEC_BTDF] * specular_btdf_evaluate(pW, basis, winputL, woutputL, rndSeed);\r
    //if (maxComponent(weights.m[ID_DIFF_BRDF]) > 0.0) f += weights.m[ID_DIFF_BRDF] *  diffuse_brdf_evaluate(pW, basis, winputL, woutputL);\r
    return f;\r
}\r
\r
...
{\r
    ...
    float W_total = 0.0;\r
    probs.m[ID_FUZZ_BRDF] = 0.0; //length(weights.m[ID_FUZZ_BRDF] * albedos.m[ID_FUZZ_BRDF]); W_total += probs.m[ID_FUZZ_BRDF];\r
    probs.m[ID_COAT_BRDF] = 0.0; //length(weights.m[ID_COAT_BRDF] * albedos.m[ID_COAT_BRDF]); W_total += probs.m[ID_COAT_BRDF];\r
    probs.m[ID_META_BRDF] = 0.0; //length(weights.m[ID_META_BRDF] * albedos.m[ID_META_BRDF]); W_total += probs.m[ID_META_BRDF];\r
    ...
    probs.m[ID_DIFF_BRDF] = 0.0; //length(weights.m[ID_DIFF_BRDF] * albedos.m[ID_DIFF_BRDF]); W_total += probs.m[ID_DIFF_BRDF];\r
    probs.m[ID_SSSC_BTDF] = 0.0; //length(weights.m[ID_SSSC_BTDF] * albedos.m[ID_SSSC_BTDF]); W_total += probs.m[ID_SSSC_BTDF];\r
\r
...
{\r
    ...
    pdfs.m[ID_COAT_BRDF] = 0.0; //    coat_brdf_pdf(pW, basis, winputL, woutputL);\r
    pdfs.m[ID_META_BRDF] = 0.0; //   metal_brdf_pdf(pW, basis, winputL, woutputL);\r
    pdfs.m[ID_SPEC_BRDF] = specular_brdf_pdf(pW, basis, winputL, woutputL);\r
    pdfs.m[ID_SPEC_BTDF] = specular_btdf_pdf(pW, basis, winputL, woutputL);\r
    pdfs.m[ID_DIFF_BRDF] = 0.0; // diffuse_brdf_pdf(pW, basis, winputL, woutputL);\r
...
\r
    ...
    {\r
        ...
        {\r
            ...
            else if (lobe_id==ID_SPEC_BTDF) { specular_btdf_sample(pW, basis, winputL, woutputL, pdf_tmp, rndSeed);   }\r
...
\r
    ...
    {\r
        ...
        if (has_normals_shell)\r
        {\r
            Ns = textureSampleBarycoord(normalAttribute_shell, barycoord_shell, faceIndices_shell.xyz).xyz;\r
            const bool flip_normals = false;\r
            if (flip_normals)\r
                Ns *= -1.0;\r
            if (dot(Ns, Ng) < 0.0) Ns *= -1.0; // align geometric normal into same hemisphere as shading normal, if supplied\r
        }\r
        else\r
            Ns = Ng;\r
    ...
    {\r
        ...
        if (has_normals_scene)\r
        {\r
            const bool flip_normals = false;\r
            if (flip_normals)\r
                Ns *= -1.0;\r
            Ns = textureSampleBarycoord(normalAttribute_scene, barycoord_scene, faceIndices_scene.xyz).xyz;\r
            if (dot(Ns, Ng) < 0.0) Ns *= -1.0; // align geometric normal into same hemisphere as shading normal, if supplied\r
        }\r
        else\r
            Ns = Ng;\r
...
{\r
    ...
    {\r
        ...
        {\r
            ...
            float misWeight = balanceHeuristic(skyPdf, bsdfPdf);\r
...
\r
            ////////////////////////////////////////////////////\r
            // DEBUG\r
            //L = throughput * f / max(PDF_EPSILON, bsdfPdf) * abs(woutputL.z);\r
            //if (vertex==1)\r
            //    break;\r
            ////////////////////////////////////////////////////\r
            \r
...
\r
            ...
            throughput *= f / max(PDF_EPSILON, bsdfPdf) * abs(woutputL.z);\r
\r
...
\r
            ...
            {\r
                // This ray missed all geometry; add contribution from distant lights and terminate path\r
                misWeightSky = balanceHeuristic(bsdfPdf, skyPdf);\r
...
`;class hb{constructor(){this.result=null,this.loader=new e0}reset(){this.result=null}async load(e){this.result&&Promise.resolve(this.result);let t=await this.loader.loadAsync(e),n=Array.isArray(t.scene)?t.scene:[t.scene];for(let i=0,s=n.length;i<s;i++)n[i].traverseVisible(o=>{if(o.isMesh){const a=new Yx(o);a.attributes=["position","color","normal","tangent","uv","uv2"],a.applyWorldTransforms=!1;const l={strategy:Ih,maxLeafTris:1};let c=new hl(a.generate(),l);return new Vt(a.generate(),o.material),this.result={scene:t.scene,bvh:c,mesh:o},console.log("==> loaded mesh ",e),this.result}});return this.result}}const ae={smoothNormals:!1,bounces:8,base_weight:0,base_color:[.8,.8,.8],base_roughness:0,base_metalness:0,specular_weight:1,specular_color:[1,1,1],specular_roughness:.3,specular_anisotropy:0,specular_rotation:0,specular_ior:1.5,specular_ior_level:.5,transmission_weight:1,transmission_color:[1,1,1],transmission_depth:0,transmission_scatter:[0,0,0],transmission_scatter_anisotropy:0,transmission_dispersion_abbe_number:20,transmission_dispersion_scale:0,subsurface_weight:0,subsurface_color:[.8,.8,.8],subsurface_radius:1,subsurface_radius_scale:[1,.5,.25],subsurface_anisotropy:0,coat_weight:0,coat_color:[1,1,1],coat_roughness:0,coat_anisotropy:0,coat_rotation:0,coat_ior:1.6,coat_ior_level:.5,fuzz_weight:0,fuzz_color:[1,1,1],fuzz_roughness:.5,geometry_opacity:1,geometry_thin_walled:!1};let Lt,un,er,an,Xa,qr,Hh,ao,fi=0,kh,pi,Qi,ba,ya,qa;db();Ya();function db(){console.log("init"),qa=!1,pi=null,Qi=null,ba=null,ya=null,Lt=new yh({antialias:!1}),Lt.setPixelRatio(window.devicePixelRatio),Lt.setClearColor(594970),Lt.setSize(window.innerWidth,window.innerHeight),Lt.outputEncoding=Jn,document.body.appendChild(Lt.domElement),kh=document.getElementById("output"),er=new cv;const r=new Rh(16777215,1);r.position.set(1,1,1),er.add(r),er.add(new Bv(11583173,.5)),un=new Ft(75,window.innerWidth/window.innerHeight,.1,50),un.position.set(4,4,4),un.far=100,un.updateProjectionMatrix(),Xa=new O0,document.body.appendChild(Xa.dom);const e=new ei({defines:{SMOOTH_NORMALS:0,BOUNCES:ae.bounces},uniforms:{bvh_shell:{value:new Nu},normalAttribute_shell:{value:new Br},tangentAttribute_shell:{value:new Br},has_normals_shell:{value:1},has_tangents_shell:{value:0},bvh_scene:{value:new Nu},normalAttribute_scene:{value:new Br},tangentAttribute_scene:{value:new Br},has_normals_scene:{value:1},has_tangents_scene:{value:0},cameraWorldMatrix:{value:new Te},invProjectionMatrix:{value:new Te},invModelMatrix:{value:new Te},resolution:{value:new Se},seed:{value:0},accumulation_weight:{value:1},base_weight:{value:ae.base_weight},base_color:{value:new R(.8,.8,.8)},base_roughness:{value:ae.base_roughness},base_metalness:{value:ae.base_metalness},specular_weight:{value:ae.specular_weight},specular_color:{value:new R(1,1,1)},specular_roughness:{value:ae.specular_roughness},specular_anisotropy:{value:0},specular_rotation:{value:0},specular_ior:{value:ae.specular_ior},specular_ior_level:{value:.5},transmission_weight:{value:ae.transmission_weight},transmission_color:{value:new R(1,1,1)},transmission_depth:{value:0},transmission_scatter:{value:new R(0,0,0)},transmission_scatter_anisotropy:{value:0},transmission_dispersion_abbe_number:{value:20},transmission_dispersion_scale:{value:0},subsurface_weight:{value:0},subsurface_color:{value:new R(.8,.8,.8)},subsurface_radius:{value:1},subsurface_radius_scale:{value:new R(1,.5,.25)},subsurface_anisotropy:{value:0},coat_weight:{value:0},coat_color:{value:new R(1,1,1)},coat_roughness:{value:0},coat_anisotropy:{value:0},coat_rotation:{value:0},coat_ior:{value:1.6},coat_ior_level:{value:.5},fuzz_weight:{value:0},fuzz_color:{value:new R(1,1,1)},fuzz_roughness:{value:.5},geometry_opacity:{value:1},geometry_thin_walled:{value:!1}},vertexShader:`
        ...
        `,fragmentShader:`precision highp isampler2D;
                         ...
                         ${kx}
                         ${Vx}
                        `+ib+rb+ob+ab+sb+lb+cb+ub}),t=new hb;t.load("standard-shader-ball/core_base_floor.gltf").then(()=>{er.add(t.result.scene),Qi=t.result.mesh,ya=t.result.bvh,e.uniforms.bvh_scene.value.updateFrom(ya),e.uniforms.has_normals_scene.value=!1,e.uniforms.has_tangents_scene.value=!1,Qi.geometry.attributes.normal&&(e.uniforms.normalAttribute_scene.value.updateFrom(Qi.geometry.attributes.normal),e.uniforms.has_normals_scene.value=!0),Qi.geometry.attributes.tangent&&(e.uniforms.tangentAttribute_scene.value.updateFrom(Qi.geometry.attributes.tangent),e.uniforms.has_tangents_scene.value=!0),console.log("  has_normals_scene:  ",e.uniforms.has_normals_scene),console.log("  has_tangents_scene: ",e.uniforms.has_tangents_scene),t.reset(),t.load("standard-shader-ball/shell.gltf").then(()=>{er.add(t.result.scene),pi=t.result.mesh,ba=t.result.bvh,e.uniforms.bvh_shell.value.updateFrom(ba),e.uniforms.has_normals_shell.value=!1,e.uniforms.has_tangents_shell.value=!1,pi.geometry.attributes.normal&&(e.uniforms.normalAttribute_shell.value.updateFrom(pi.geometry.attributes.normal),e.uniforms.has_normals_shell.value=!0),pi.geometry.attributes.tangent&&(e.uniforms.tangentAttribute_shell.value.updateFrom(pi.geometry.attributes.tangent),e.uniforms.has_tangents_shell.value=!0),console.log("  has_normals_shell:  ",e.uniforms.has_normals_shell),console.log("  has_tangents_shell: ",e.uniforms.has_tangents_shell),fb(e),console.log("===> LOADED"),qa=!0})})}function fb(r){let e=new Kv(un,Lt.domElement);e.addEventListener("change",()=>{Ve()});let t=new ut;t.setFromObject(pi);let n=t.min,i=t.max,s=Math.max(i.x-n.x,i.y-n.y,i.z-n.z),o=[n.x,n.y,n.z],a=[i.x-n.x,i.y-n.y,i.z-n.z],l=new R(o[0]+.5*a[0],o[1]+.5*a[1],o[2]+.5*a[2]),c=new R(o[0]+a[0],o[1]+a[1],o[2]+a[2]),u=l.clone();u.sub(c),u.normalize();let h=l.clone();h.addScaledVector(u,-2*s),un.position.copy(h),e.target.copy(l),e.update(),qr=new hu(r),r.transparent=!0,r.depthWrite=!1,ao=new Qn(1,1,{format:Mt,type:Ut}),Hh=new hu(new jn({map:ao.texture})),an=new dl,an.add(ae,"smoothNormals").onChange(v=>{qr.material.defines.SMOOTH_NORMALS=Number(v),qr.material.needsUpdate=!0,Ve()}),an.add(ae,"bounces",1,16,1).onChange(v=>{r.defines.BOUNCES=parseInt(v),r.needsUpdate=!0,Ve()});const d=an.addFolder("Base");d.add(ae,"base_weight",0,1).onChange(v=>{r.needsUpdate=!0,Ve()}),d.addColor(ae,"base_color").onChange(v=>{r.needsUpdate=!0,Ve()}),d.add(ae,"base_roughness",0,1).onChange(v=>{r.needsUpdate=!0,Ve()}),d.add(ae,"base_metalness",0,1).onChange(v=>{r.needsUpdate=!0,Ve()});const p=an.addFolder("Specular");p.add(ae,"specular_weight",0,1).onChange(v=>{r.needsUpdate=!0,Ve()}),p.addColor(ae,"specular_color").onChange(v=>{r.needsUpdate=!0,Ve()}),p.add(ae,"specular_roughness",0,1).onChange(v=>{r.needsUpdate=!0,Ve()}),p.add(ae,"specular_ior",1,3).onChange(v=>{r.needsUpdate=!0,Ve()}),p.add(ae,"specular_ior_level",0,1).onChange(v=>{r.needsUpdate=!0,Ve()}),p.add(ae,"specular_anisotropy",0,1).onChange(v=>{r.needsUpdate=!0,Ve()}),p.add(ae,"specular_rotation",0,1).onChange(v=>{r.needsUpdate=!0,Ve()});const g=an.addFolder("Transmission");g.add(ae,"transmission_weight",0,1).onChange(v=>{r.needsUpdate=!0,Ve()}),g.addColor(ae,"transmission_color").onChange(v=>{r.needsUpdate=!0,Ve()}),g.add(ae,"transmission_depth",0,1).onChange(v=>{r.needsUpdate=!0,Ve()}),g.addColor(ae,"transmission_scatter").onChange(v=>{r.needsUpdate=!0,Ve()}),g.add(ae,"transmission_scatter_anisotropy",-1,1).onChange(v=>{r.needsUpdate=!0,Ve()}),g.add(ae,"transmission_dispersion_abbe_number",9,91).onChange(v=>{r.needsUpdate=!0,Ve()}),g.add(ae,"transmission_dispersion_scale",0,1).onChange(v=>{r.needsUpdate=!0,Ve()}),g.close();const _=an.addFolder("Subsurface");_.add(ae,"subsurface_weight",0,1).onChange(v=>{r.needsUpdate=!0,Ve()}),_.addColor(ae,"subsurface_color").onChange(v=>{r.needsUpdate=!0,Ve()}),_.add(ae,"subsurface_radius",0,1).onChange(v=>{r.needsUpdate=!0,Ve()}),_.addColor(ae,"subsurface_radius_scale").onChange(v=>{r.needsUpdate=!0,Ve()}),_.add(ae,"subsurface_anisotropy",-1,1).onChange(v=>{r.needsUpdate=!0,Ve()}),_.close();const m=an.addFolder("Coat");m.add(ae,"coat_weight",0,1).onChange(v=>{r.needsUpdate=!0,Ve()}),m.addColor(ae,"coat_color").onChange(v=>{r.needsUpdate=!0,Ve()}),m.add(ae,"coat_roughness",0,1).onChange(v=>{r.needsUpdate=!0,Ve()}),m.add(ae,"coat_ior",1,3).onChange(v=>{r.needsUpdate=!0,Ve()}),m.add(ae,"coat_ior_level",0,1).onChange(v=>{r.needsUpdate=!0,Ve()}),m.add(ae,"coat_anisotropy",0,1).onChange(v=>{r.needsUpdate=!0,Ve()}),m.add(ae,"coat_rotation",0,1).onChange(v=>{r.needsUpdate=!0,Ve()});const f=an.addFolder("Fuzz");f.add(ae,"fuzz_weight",0,1).onChange(v=>{r.needsUpdate=!0,Ve()}),f.addColor(ae,"fuzz_color").onChange(v=>{r.needsUpdate=!0,Ve()}),f.add(ae,"fuzz_roughness",0,1).onChange(v=>{r.needsUpdate=!0,Ve()}),f.close();const x=an.addFolder("Geometry");x.add(ae,"geometry_opacity",0,1).onChange(v=>{r.needsUpdate=!0,Ve()}),x.add(ae,"geometry_thin_walled").onChange(v=>{r.needsUpdate=!0,Ve()}),an.open(),window.addEventListener("resize",ku,!1),ku()}function Ve(){fi=0}function ku(){un.aspect=window.innerWidth/window.innerHeight,un.updateProjectionMatrix();const r=window.innerWidth,e=window.innerHeight;Lt.setSize(r,e),Lt.setPixelRatio(1),ao.setSize(r,e),Ve()}function Xn(r){return new R(r[0],r[1],r[2])}function Ya(){if(!qa){console.log("not LOADED"),requestAnimationFrame(Ya);return}if(console.log("render"),Xa.update(),requestAnimationFrame(Ya),Lt.domElement.style.imageRendering="auto",!(fi>=512)){{un.updateMatrixWorld();const e=qr.material.uniforms,t=window.innerWidth,n=window.innerHeight,i=fi*t*n%31415926;e.seed.value=i,e.accumulation_weight.value=1/(fi+1),e.cameraWorldMatrix.value.copy(un.matrixWorld),e.invProjectionMatrix.value.copy(un.projectionMatrixInverse),e.invModelMatrix.value.copy(er.matrixWorld).invert();let s=new Se(t,n);e.resolution.value.copy(s),e.base_weight.value=ae.base_weight,e.base_color.value.copy(Xn(ae.base_color)),e.base_roughness.value=ae.base_roughness,e.base_metalness.value=ae.base_metalness,e.specular_weight.value=ae.specular_weight,e.specular_color.value.copy(Xn(ae.specular_color)),e.specular_roughness.value=ae.specular_roughness,e.specular_anisotropy.value=ae.specular_anisotropy,e.specular_rotation.value=ae.specular_rotation,e.specular_ior.value=ae.specular_ior,e.specular_ior_level.value=ae.specular_ior_level,e.transmission_weight.value=ae.transmission_weight,e.transmission_color.value.copy(Xn(ae.transmission_color)),e.transmission_depth.value=ae.transmission_depth,e.transmission_scatter.value.copy(Xn(ae.transmission_scatter)),e.transmission_scatter_anisotropy.value=ae.transmission_scatter_anisotropy,e.transmission_dispersion_abbe_number.value=ae.transmission_dispersion_abbe_number,e.transmission_dispersion_scale.value=ae.transmission_dispersion_scale,e.subsurface_weight.value=ae.subsurface_weight,e.subsurface_color.value.copy(Xn(ae.subsurface_color)),e.subsurface_radius.value=ae.subsurface_radius,e.subsurface_radius_scale.value.copy(Xn(ae.subsurface_radius_scale)),e.subsurface_anisotropy.value=ae.subsurface_anisotropy,e.coat_weight.value=ae.coat_weight,e.coat_color.value.copy(Xn(ae.coat_color)),e.coat_roughness.value=ae.coat_roughness,e.coat_anisotropy.value=ae.coat_anisotropy,e.coat_rotation.value=ae.coat_rotation,e.coat_ior.value=ae.coat_ior,e.coat_ior_level.value=ae.coat_ior_level,e.fuzz_weight.value=ae.fuzz_weight,e.fuzz_color.value.copy(Xn(ae.fuzz_color)),e.fuzz_roughness.value=ae.fuzz_roughness,e.geometry_opacity.value=ae.geometry_opacity,e.geometry_thin_walled.value=ae.geometry_thin_walled,Lt.autoClear=fi===0,Lt.setRenderTarget(ao),qr.render(Lt),Lt.setRenderTarget(null),Hh.render(Lt),Lt.autoClear=!0,fi++}kh.innerText=`samples: ${fi}`}}
